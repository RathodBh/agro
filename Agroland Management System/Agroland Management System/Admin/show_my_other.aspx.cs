...
namespace Agroland_Management_System.Admin
{
    public partial class WebForm6 : System.Web.UI.Page
    {
        ...
        public void new_load()
        {
            ...
            cmd.CommandText = "select * from new_products where category = '" + name.ToString() + "'";
            cmd.ExecuteNonQuery();
            ...
            else
            {
                ...
                notFound1.Text = " Total " + i + " other products available";
                r1.DataSource = dt;
                r1.DataBind();
            }
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            cmd0.CommandText = "select * from new_products where (pname like '%'+'" + search1.Text + "'+'%' or description like '%'+'" + search1.Text + "'+'%'  or price like '%'+'" + search1.Text + "'+'%') and category = '" + name.ToString() + "'";
