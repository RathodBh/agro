<%@ Page Title="" Language="C#" MasterPageFile="~/User/UserMenu.Master" AutoEventWireup="true" CodeBehind="bill_prod.aspx.cs" Inherits="Agroland_Management_System.User.WebForm15" %>
    ...
    <asp:Repeater runat="server" ID="r2">
            ...
            <tr>
                ...
                <div style="display: flex; flex-direction:row ; justify-content: space-between;">
                    ...
                    <div>
                    Bill no.: <span class="text-primary">B1<%#Eval("id") %></span> 
                    </div>
                </div>
                </th>
             </tr>
