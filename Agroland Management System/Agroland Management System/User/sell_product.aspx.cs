            ...
            if (i0 > 0)
            {
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        cmd.CommandText = "insert into cust_products values('" + p_name.Text + "','" + p_desc.Text + "'," + p_price.Text + ",'" + dd_category.Text + "', '" + img_path.ToString() + "','" + unm.Text + "','" + email.Text + "','" + phno.Text + "','" + addr.Text + "','" + ct.Text + "','n')";
                        cmd.ExecuteNonQuery();
