...
namespace Agroland_Management_System.User
{
    public partial class WebForm11 : System.Web.UI.Page
    {
        ...
        public void new_load()
        {
            ...
            cmd.CommandText = "select * from cust_products where ct != 'c' and email !='" + Session["user_email"] + "' and req='n'";
            cmd.ExecuteNonQuery();
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            cmd0.CommandText = "select * from cust_products where (pname like '%'+'" + search1.Text + "'+'%' or description like '%'+'" + search1.Text + "'+'%'  or price like '%'+'" + search1.Text + "'+'%' or ct like '%'+'" + search1.Text + "'+'%') and ct != 'c' and email='" + Session["user_email"] + "'and req='n'";
